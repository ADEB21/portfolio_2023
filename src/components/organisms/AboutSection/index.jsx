    ...
    <section className={`${AboutSectionStyle.ad_aboutSection}`}>
      <div className={`${AboutSectionStyle.ad_aboutSection_container}`}>
        ...
        <div className={`${AboutSectionStyle.ad_aboutSection_container_content}`}>
            ...
            <p>Si vous recherchez un développeur créatif qui allie compétences techniques et sensibilité artistique, je serais ravi de collaborer avec vous. N'hésitez pas à me <a className="ad-mid-body" href="/contact">contacter</a> pour discuter de vos idées et de vos projets passionnants.</p>
        </div>
      </div>
    </section>
  );
